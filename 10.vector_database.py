...
# view documents
view = vector_store.get(include=['embeddings','documents', 'metadatas'])
print(view)
...
search2 = vector_store.similarity_search_with_score(
    query='Who among these are a bowler?',
    k=2
)
print(search2)
...
# delete document
delete = vector_store.delete(ids=['09a39dc6-3ba6-4ea7-927e-fdda591da5e4'])
print(delete)
